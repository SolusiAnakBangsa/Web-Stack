...
export class CharacterSpine {
    constructor(pixiRef) {
        ...
        this.fightMan2 = new PIXI.spine.Spine(
            pixiRef.resources.fightman2.spineData
        );
    ...
    changePose(pose, loop) {
        ...
        let trackEntry = this.currentSprite.state.setAnimation(
            0,
            this.currentPose,
            loop
        );
...
export class FightMan extends GameObject {
    ...
    repOnce() {
        ...
        this.fightMan.currentSprite.state.setAnimation(
            0,
            this.fightMan.currentPose,
            false
        );
    }
