...
export class Floor extends GameObject {
    constructor(pixiRef, drawTo) {
        ...
        this.counterRange = [
            400 / this.spawnMultiplier,
            800 / this.spawnMultiplier,
        ]; // Milliseconds range to spawn the floor decorations
        this.counter = 0;
    ...
    setup() {
        ...
        this.road.tilePosition.x +=
            (pixiRef.resources.landroad.texture.width / 2) * scale; // Offset by half
    ...
    setFloorSpeed(speed) {
        ...
        // Change range
        this.counterRange = [
            5600 / this.spawnMultiplier / speed,
            11200 / this.spawnMultiplier / speed,
        ];
