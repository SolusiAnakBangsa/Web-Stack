...
export const FITINSTR = {
    RhomboidPull: `- Stand up straight, move your chest forward.
...
- If it's too hard, straighten your legs.`,
    ...
    ReclinedRhomboidSqueeze: `- Make sure the entirety of your soles touches the ground
...
`,
    ...
    JumpingSquat: `- Place your hands behind your ears
...
`,
    ...
    PushUp: `- When going down, DO NOT let your upper arms be 90 degrees with your body. Your upper arm should be in line with your body.
...
`,
    ...
    KneePushUp: `- When going down, DO NOT let your upper arms be 90 degrees with your body. Your upper arm should be in line with your body.
...
- Your upper arm should not face away from your body.`,
    ...
    ForwardLunge: `- Touch your hips with both your hands
...
- Alternate between your legs.`,
    ...
    HighKnee: `- Like jogging, but raise your thighs to be as in line with the floor.
